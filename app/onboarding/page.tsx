...
// Categorie standard definite dall'utente
...
export default function OnboardingPage() {
  ...
  const processCsvData = (csvContent: string) => {
    try {
      ...
      const stageColumnKey = headers.find((key) => key.toLowerCase().trim() === 'stage')
            ...
            <div className="space-y-6">
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                <p className="text-blue-800">
                  Carica il CSV della pipeline per iniziare. Il sistema estrarrà
                  automaticamente gli stage da mappare.
                </p>
              </div>
